...
// loop like
export const likeLoops= async (req, res) => {
    try {
...
export const commentLoops = async (req, res) => {
    try {
...
export const getAllLoops = async (req, res) => {
    try {
        ...
        const loops = await Loop.find({}).populate({ author: req.userId }).
